...
const ProjectsComponent = (props: { projectContent: React.ReactElement }) => {
  ...
  return (
    <div
      ...
      id="projects"
      className="md:w-screen md:min-h-[100vh] pt-10 gap-20 lg:gap-10  sm:gap-x-20 pb-10 md:px-5 flex-col flex flex-wrap  md:flex-row justify-center lg:justify-start items-center overflow-hidden">
      <p
